...
async function getHealthPage() {
  return client.fetch(`*[_type == "page" && slug.current == "health"][0]{ title, content }`)
}
    ...
    <main>
      ...
      <section className="min-h-screen pt-32 bg-novothor-dark text-white">
        <div className="container mx-auto px-4">
          <h1 className="text-6xl font-light mb-8">{page?.title || 'Health'}</h1>
